...
public class AdvanceQueryInterfaceAction extends BaseAction
{
			...
			ServletException
	{
		...
		if (operation == null)
		{
			...
			request.getSession().setAttribute(edu.wustl.clinportal.util.global.Constants.ADVANCED_CONDITIONS_ROOT, root);
		}

		String pageOf = (String) request.getParameter(Constants.PAGEOF);
		request.setAttribute(Constants.MENU_SELECTED, "17");
		Logger.out.debug(Constants.MENU_SELECTED
				+ " set in Advance Query Interface Action : 17  -- ");
