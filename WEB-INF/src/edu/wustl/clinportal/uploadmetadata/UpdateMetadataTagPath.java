...
public class UpdateMetadataTagPath
{
	...
	//Logger
	private static final Logger LOGGER = Logger.getCommonLogger(UpdateMetadataTagPath.class);
	...
	public static void main(String[] args)
	{
		try
		{
			...
			addAssociations.addCuratedPath("edu.wustl.clinportal.domain.Participant",
					"edu.wustl.clinportal.domain.EventEntry",
			...
			DynamicExtensionsApplicationException
	{
		...
		{
			throw new DynamicExtensionsApplicationException("error in saving object!!!!", ex);
		}
	}
