...
public class Constants
{
	...
	public static final String[] APPROVE_USER_STATUS_VALUES = {SELECT_OPTION,
			APPROVE_USER_APPROVE_STATUS, APPROVE_USER_REJECT_STATUS, APPROVE_USER_PENDING_STATUS,};
	...
	*/
	...
	public static final String ODD_COLOR = "#FFFFFF";
	...
	public static final String PACKAGE_DOMAIN = "edu.wustl.clinportal.domain";
	...
	public static final String PARTICIPANT_LOOKUP_ALGO_FOR_MIGRATION = "ParticipantLookupAlgoForMigration";
	...
	public static final String MIG_PARTICIPANT_SSN_EXACT = "MigSSNExact";
	...
	public static final String SPECIMEN_ARRAY_CLASSNAME = "edu.wustl.clinportal.domain.SpecimenArray";
	public static final String SPECIMEN_ARRAY_TYPE_CLASSNAME = "edu.wustl.clinportal.domain.SpecimenArrayType";
	// End
	 ...
	 * Changes result per page options, removed 5000 from the array & added 500 as another option. 
	 */
	...
	/**
	 * Used to separate storage container, xPos, yPos
	 */
	...
	//multiple specimen Applet constants
	...
	//Specimen Label generation related constants 
	...
	public static final int EVENT_ENTRY_FORM_ID = 69;
	...
	//clinical study
	/**
	 * Clinical Study Search URL
	 */
	public static final String CLINICAL_STUDY_SEARCH_ACTION = "ClinicalStudySearch.do";
	/**
	 * Clinical Study Add URL
	 */
	public static final String CLINICAL_STUDY_ADD_ACTION = "ClinicalStudyAdd.do";
	/**
	 * Clinical Study Edit URL
	 */
	public static final String CLINICAL_STUDY_EDIT_ACTION = "ClinicalStudyEdit.do";
	/**
	 * list of clinical studies
	 */
	public static final String CLINICAL_STUDY_LIST = "clinicalStudyList";
	public static final String PAGE_OF_CLINICAL_STUDY_REGISTRATION_CP_QUERY = "pageOfClinicalStudyRegistrationCPQuery";

	public static final String CLINICAL_STUDY_REGISTRATION_SEARCH_ACTION = "ClinicalStudyRegistrationSearch.do";
	public static final String CLINICAL_STUDY_REGISTRATION_ADD_ACTION = "ClinicalStudyRegistrationAdd.do";
	public static final String CLINICAL_STUDY_REGISTRATION_EDIT_ACTION = "ClinicalStudyRegistrationEdit.do";
	public static final String CP_QUERY_CLINICAL_STUDY_REGISTRATION_ADD_ACTION = "CPQueryClinicalStudyRegistrationAdd.do";
	public static final String CP_QUERY_CLINICAL_STUDY_REGISTRATION_EDIT_ACTION = "CPQueryClinicalStudyRegistrationEdit.do";

	public static final String CS_LIST = "csList";
	public static final String SHOW_CS_AND_PARTICIPANTS_ACTION = "showCsAndParticipants.do";
	/**
	 * Clinical Study alias
	 */
	public static final String ALIAS_CLINICAL_STUDY = "ClinicalStudy";
	public static final String PAGE_OF_CLINICAL_STUDY = "pageOfClinicalStudy";
	public static final String STUDY_FORMS_LIST = "studyFormsList";

	public static final String CLINICAL_STUDY_FORM = "clinicalStudyForm";
	public static final String CLINICAL_STUDY_EVENT = "ClinicalStudyEvent:";
	public static final String FORM_CONTEXT = "StudyFormContext:";
	public static final String ENTITY_MAP_CONDITION = "EnitityMapCondition:";

	public static final String CLINICAL_STUDY_EVENT_OBJECT = "ClinicalStudyEvent";
	public static final String FORM_CONTEXT_OBJECT = "StudyFormContext";
	public static final String SINGLE_RECORD_FORM = "SingleRecordForm";
	public static final String SINGLE_RECORD_FORM_EDIT = "SingleRecordFormEdit";

	public static final String NO_OF_ENTRIES_DEFINED = "defined";
	public static final String NO_OF_ENTRIES_UNDEFINED = "undefined";

	public static final String CS_TREE_VIEW_ACTION = "showEventTree.do";
	 ...
	 * @return
	 */
	public static final String getClinicalStudyPGName(Long identifier)
	{
		String str = "CLINICAL_STUDY_";
		if (identifier != null)
		{
			str = "CLINICAL_STUDY_" + identifier;
		}
		return str;
	}
	 ...
	 * @return
	 */
	public static final String getClinicalStudyPIGroupName(Long identifier)
	{
		String str = "PI_CLINICAL_STUDY_";
		if (identifier != null)
		{
			str = "PI_CLINICAL_STUDY_" + identifier;
		}
		return str;
	}
	 ...
	 * @return
	 */
	public static final String getClinicalStudyCoordinatorGroupName(Long identifier)
	{
		String str = "COORDINATORS_CLINICAL_STUDY_";
		if (identifier != null)
		{
			str = "COORDINATORS_CLINICAL_STUDY_" + identifier;
		}
		return str;
	}
	...
	public static final String EVENT_COUNTER = "eventCounter";

	public static final String INFINITE_ENTRY = "infinite_entry";
	public static final String IS_TO_DELETE = "button";
	public static final String CONSENT_DELETE = "removeButton";

	public static final String FORWARD_CONTROLLER = "ComingFrom";

	public static final String EVENT_ENTRY_OBJECT = "EventEntry";
	public static final String FORM_ENTRY_OBJECT = "FormEntry";

	public static final String IS_EVENT_DATE_SUBMITTED = "isDateSubmit";

	public static final String IS_TO_REFRESH_TREE = "isToRefreshTree";

	public static final String SUITE_CACORE_SERVICE_URL = "suiteCacoreServiceUrl";
	public static final String SUITE_SERVICE_CRT_KEY_PATH = "suiteServiceCrtKeyPath";
	public static final String JMS_PROVIDER_URL = "jmsProviderUrl";
	public static final String PARTICIPANT_SERVICE_ENABLED = "participantServiceEnabled";
	public static final String INSERT = "insert";
	public static final String UPDATE = "update";
	public static final String CATISSUE_ADMIN_LOGIN_ID = "catissueAdminLoginId";

	public static final int ENTRY_NUM_INDEX = 2;
	public static final int EVENT_ENTRY_ID = 0;
	public static final int ENCOUNTERDATE_INDEX = 1;

	public static final int FORMCONTEXT_ID_INDEX = 0;
	public static final int CONTAINER_ID_INDEX = 1;
	public static final int STUDY_FORM_LABLE_INDEX = 2;
	public static final int CAN_HOLD_MULTIPLE_RECORD_INDEX = 3;
	public static final String DELETE_XML = "deleteXML";

	// Reports Tab Constants : Deepali
	/**
	 * consider all reports - used to store in session
	 */
	public static final String REPORTS_ALL = "reportAll";
	/**
	 * reports accessible to user  - used to store in session 
	 */
	public static final String REPORTS_AUTHORIZED = "reportAuthorized";
	public static final String CRYSTAL_REPORT_VIEWER = "crystalReportViewer";

	public static final String OUTPUT_TERMS_COLUMNS = "outputTermsColumns";

	/**
	 * Clinical Study Activity Status
	 */
	...
	// Adding constants from common package but needed in Clinportal
