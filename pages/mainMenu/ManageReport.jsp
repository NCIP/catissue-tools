		...
		<table summary="" cellpadding="0" cellspacing="0" border="0" height="20">
            <tr>
			 ...
			 <td><img src="images/mainMenuSeparator.gif" width="1" height="16" alt="" /></td>
              ...
              <!-- link 3 begins -->
              <td height="20" class="mainMenuItem" onclick="document.location.href='ManageBioSpecimen.do'">
             ...
             <!-- link 3 ends -->
              ...
              <!-- Deepali changes -->         
              <!--<td height="20" class="mainMenuItemSelected" onclick="document.location.href='ManageReports.do'">
