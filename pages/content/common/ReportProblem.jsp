...
<%@ page import="edu.wustl.clinportal.util.global.Variables,edu.wustl.clinportal.util.global.Constants"%>
<%
    ...
    <td class="tablepadding"><table width="100%" border="0" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <td align="left" valign="top" class="showhide"><table width="100%" border="0" cellpadding="3" cellspacing="0">
              ...
              <tr>
                <td width="1%" align="center" class="black_ar_new"><img src="images/uIEnhancementImages/star.gif" alt="Mandatory Field" width="6" height="6" hspace="0" vspace="0" /></td>
                <td width="16%" align="left" class="black_ar_new"><bean:message key="fields.from" /></td>
                <td width="83%" align="left" valign="middle"><span class="black_ar_new">
                  <html:text  styleClass="black_ar_new" maxlength="255" size="30"
															styleId="from" property="from"	readonly="<%=readOnlyValue%>" />
                </span>                  </tr>
              <tr>
                <td align="center" class="black_ar_new"><img src="images/uIEnhancementImages/star.gif" alt="Mandatory Field" width="6" height="6" hspace="0" vspace="0" /></td>
                <td align="left" class="black_ar_new"><bean:message key="fields.nameofreporter" /></td>
                <td align="left" valign="middle"><span class="black_ar_new">
                  <html:text  styleClass="black_ar_new" maxlength="255" size="30"
															styleId="nameOfReporter" property="nameOfReporter"	readonly="<%=readOnlyValue%>" />
                </span>                   </tr>
              <tr>
                <td align="center" class="black_ar_new"><img src="images/uIEnhancementImages/star.gif" alt="Mandatory Field" width="6" height="6" hspace="0" vspace="0" /></td>
                <td align="left" class="black_ar_new"><bean:message key="fields.affiliation" /></td>
                <td align="left" valign="middle"><span class="black_ar_new">
                  <html:text  styleClass="black_ar_new" maxlength="255" size="30"
              ...
              <tr>
                <td align="center" class="black_ar_new"><img src="images/uIEnhancementImages/star.gif" alt="Mandatory Field" width="6" height="6" hspace="0" vspace="0" /></td>
                <td align="left" class="black_ar_new"><bean:message key="fields.title" /> </td>
                <td align="left" valign="middle"><span class="black_ar_new">
                  <html:text  styleClass="black_ar_new" maxlength="255" size="30"
              ...
              <tr>
                <td align="center" class="black_ar_new"><img src="images/uIEnhancementImages/star.gif" alt="Mandatory Field" width="6" height="6" hspace="0" vspace="0" /></td>
                <td align="left" class="black_ar_new"><bean:message key="fields.message" /> </td>
				...
				<tr>
				<td align="center" class="black_ar_new"><img src="images/uIEnhancementImages/star.gif" alt="Mandatory Field" width="6" height="6" hspace="0" vspace="0" /></td>
                <td align="left" class="black_ar_new"><bean:message key="reportProblem.status" /></td>	
