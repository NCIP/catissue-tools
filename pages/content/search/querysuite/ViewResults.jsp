...
<table border="0" height="100%" width="100%">
	<tr height="100%">
		...
		<td width="75%" colspan="3" valign="top">
			<iframe name="<%=Constants.GRID_DATA_VIEW_FRAME%>" src="<%=Constants.QUERY_GRID_VIEW_ACTION%>?pageOf=pageOfQueryModule" <%=edu.wustl.query.util.global.AQConstants.VIEW_TYPE%>=<%=edu.wustl.simplequery.global.Constants.SPREADSHEET_VIEW%>" scrolling="auto" frameborder="0" width="100%" height="100%">
				Your Browser doesn't support IFrames.
			</iframe>
		</td>
	</tr>
