...
<%@ page import="edu.wustl.clinportal.actionForm.ConfigureResultViewForm"%>
...
<%
	...
	{
		callAction=Constants.SIMPLE_SEARCH_AFTER_CONFIGURE_ACTION+"?pageOf="+edu.wustl.simplequery.global.Constants.PAGEOF_SIMPLE_QUERY_INTERFACE;
	...
	else if(pageOf.equals(edu.wustl.query.util.global.AQConstants.PAGEOF_QUERY_RESULTS))
	{
