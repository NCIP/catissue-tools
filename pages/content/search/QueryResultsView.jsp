...
<table border="0" height="100%" width="100%">
	<tr height="100%">
		...
		<td width="70%">
			<iframe name="<%=Constants.DATA_VIEW_FRAME%>" src="<%=Constants.DATA_VIEW_ACTION+edu.wustl.common.util.global.Constants.ROOT%>&<%=edu.wustl.query.util.global.AQConstants.VIEW_TYPE%>=<%=edu.wustl.simplequery.global.Constants.SPREADSHEET_VIEW%>" scrolling="auto" frameborder="1" width="99%" height="<%=height%>">
				Your Browser doesn't support IFrames.
			</iframe>
		</td>
	</tr>
