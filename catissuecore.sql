...
alter table CATISSUE_REPORT_PARTICIP_REL drop foreign key FKD17D619D91092806
alter table CATISSUE_REPORT_PARTICIP_REL drop foreign key FKD17D619D87E5ADC7
...
alter table CATISSUE_EXISTING_SP_ORD_ITEM drop foreign key FK544108BB60773DB2
alter table CATISSUE_EXISTING_SP_ORD_ITEM drop foreign key FK544108BBBC7298A9
alter table CATISSUE_CLINICAL_STUDY drop foreign key FKC6723679BC7298A9
...
alter table CATISSUE_CLINICAL_STUDY_COORDINATORS drop foreign key FKDCBC534983880B1D
alter table CATISSUE_CLINICAL_STUDY_COORDINATORS drop foreign key FKDCBC53492206F20F
...
alter table CATISSUE_REPORT_SECTION drop foreign key FK282BA7B64DA82D13
alter table CATISSUE_SPECI_ARRAY_CONTENT drop foreign key FK363E164692AB74B4
alter table CATISSUE_SPECI_ARRAY_CONTENT drop foreign key FK363E1646C4A3C438
alter table CATISSUE_SPECI_ARRAY_CONTENT drop foreign key FK363E164660773DB2
...
alter table CATISSUE_DERIEVED_SP_ORD_ITEM drop foreign key FK87BB733860773DB2
alter table CATISSUE_DERIEVED_SP_ORD_ITEM drop foreign key FK87BB7338BC7298A9
...
alter table CATISSUE_ST_CONT_ST_TYPE_REL drop foreign key FKF3393727B3DFB11D
alter table CATISSUE_ST_CONT_ST_TYPE_REL drop foreign key FKF339372759A3CE5C
...
alter table CATISSUE_CONT_HOLDS_SPARRTYPE drop foreign key FKDC7E31E2ECE89343
alter table CATISSUE_CONT_HOLDS_SPARRTYPE drop foreign key FKDC7E31E2B3DFB11D
...
alter table CATISSUE_ST_CONT_COLL_PROT_REL drop foreign key FK5A00CB6948304401
alter table CATISSUE_ST_CONT_COLL_PROT_REL drop foreign key FK5A00CB69B3DFB11D
alter table CATISSUE_SPECIMEN_ARRAY_TYPE drop foreign key FKD36E0B9BBC7298A9
alter table CATISSUE_REVIEW_PARAMS drop foreign key FK780ADBD191092806
alter table CATISSUE_REVIEW_PARAMS drop foreign key FK780ADBD12206F20F
...
alter table CATISSUE_RETURN_EVENT_PARAM drop foreign key FK8F6C44D5BC7298A9
...
alter table CATISSUE_STOR_TYPE_HOLDS_TYPE drop foreign key FK185C50B59A3CE5C
alter table CATISSUE_STOR_TYPE_HOLDS_TYPE drop foreign key FK185C50B81236791
...
alter table CATISSUE_STORTY_HOLDS_SPARRTY drop foreign key FK70F57E4459A3CE5C
alter table CATISSUE_STORTY_HOLDS_SPARRTY drop foreign key FK70F57E44ECE89343
...
drop table if exists CATISSUE_CLINICAL_STUDY_COORDINATORS
...
create table CATISSUE_CLINICAL_STUDY_COORDINATORS (
...
alter table CATISSUE_REPORT_PARTICIP_REL add index FKD17D619D91092806 (REPORT_ID), add constraint FKD17D619D91092806 foreign key (REPORT_ID) references CATISSUE_REPORT_QUEUE (IDENTIFIER)
alter table CATISSUE_REPORT_PARTICIP_REL add index FKD17D619D87E5ADC7 (PARTICIPANT_ID), add constraint FKD17D619D87E5ADC7 foreign key (PARTICIPANT_ID) references CATISSUE_PARTICIPANT (IDENTIFIER)
...
alter table CATISSUE_EXISTING_SP_ORD_ITEM add index FK544108BB60773DB2 (SPECIMEN_ID), add constraint FK544108BB60773DB2 foreign key (SPECIMEN_ID) references CATISSUE_SPECIMEN (IDENTIFIER)
alter table CATISSUE_EXISTING_SP_ORD_ITEM add index FK544108BBBC7298A9 (IDENTIFIER), add constraint FK544108BBBC7298A9 foreign key (IDENTIFIER) references CATISSUE_SPECIMEN_ORDER_ITEM (IDENTIFIER)
...
alter table CATISSUE_CLINICAL_STUDY_COORDINATORS add index FKDCBC534983880B1D (CLINICAL_STUDY_ID), add constraint FKDCBC534983880B1D foreign key (CLINICAL_STUDY_ID) references CATISSUE_CLINICAL_STUDY (IDENTIFIER)
alter table CATISSUE_CLINICAL_STUDY_COORDINATORS add index FKDCBC53492206F20F (USER_ID), add constraint FKDCBC53492206F20F foreign key (USER_ID) references CATISSUE_USER (IDENTIFIER)
...
alter table CATISSUE_REPORT_SECTION add index FK282BA7B64DA82D13 (TEXT_CONTENT_ID), add constraint FK282BA7B64DA82D13 foreign key (TEXT_CONTENT_ID) references CATISSUE_REPORT_TEXTCONTENT (IDENTIFIER)
alter table CATISSUE_SPECI_ARRAY_CONTENT add index FK363E164692AB74B4 (INITIAL_QUANTITY_ID), add constraint FK363E164692AB74B4 foreign key (INITIAL_QUANTITY_ID) references CATISSUE_QUANTITY (IDENTIFIER)
alter table CATISSUE_SPECI_ARRAY_CONTENT add index FK363E1646C4A3C438 (SPECIMEN_ARRAY_ID), add constraint FK363E1646C4A3C438 foreign key (SPECIMEN_ARRAY_ID) references CATISSUE_SPECIMEN_ARRAY (IDENTIFIER)
alter table CATISSUE_SPECI_ARRAY_CONTENT add index FK363E164660773DB2 (SPECIMEN_ID), add constraint FK363E164660773DB2 foreign key (SPECIMEN_ID) references CATISSUE_SPECIMEN (IDENTIFIER)
...
alter table CATISSUE_PATH_CASE_ORDER_ITEM add index FKBD5029D5BC7298A9 (IDENTIFIER), add constraint FKBD5029D5BC7298A9 foreign key (IDENTIFIER) references CATISSUE_SPECIMEN_ORDER_ITEM (IDENTIFIER)
...
alter table CATISSUE_DERIEVED_SP_ORD_ITEM add index FK87BB733860773DB2 (SPECIMEN_ID), add constraint FK87BB733860773DB2 foreign key (SPECIMEN_ID) references CATISSUE_SPECIMEN (IDENTIFIER)
alter table CATISSUE_DERIEVED_SP_ORD_ITEM add index FK87BB7338BC7298A9 (IDENTIFIER), add constraint FK87BB7338BC7298A9 foreign key (IDENTIFIER) references CATISSUE_SPECIMEN_ORDER_ITEM (IDENTIFIER)
...
alter table CATISSUE_ST_CONT_ST_TYPE_REL add index FKF3393727B3DFB11D (STORAGE_CONTAINER_ID), add constraint FKF3393727B3DFB11D foreign key (STORAGE_CONTAINER_ID) references CATISSUE_STORAGE_CONTAINER (IDENTIFIER)
alter table CATISSUE_ST_CONT_ST_TYPE_REL add index FKF339372759A3CE5C (STORAGE_TYPE_ID), add constraint FKF339372759A3CE5C foreign key (STORAGE_TYPE_ID) references CATISSUE_STORAGE_TYPE (IDENTIFIER)
...
alter table CATISSUE_CONT_HOLDS_SPARRTYPE add index FKDC7E31E2ECE89343 (SPECIMEN_ARRAY_TYPE_ID), add constraint FKDC7E31E2ECE89343 foreign key (SPECIMEN_ARRAY_TYPE_ID) references CATISSUE_SPECIMEN_ARRAY_TYPE (IDENTIFIER)
alter table CATISSUE_CONT_HOLDS_SPARRTYPE add index FKDC7E31E2B3DFB11D (STORAGE_CONTAINER_ID), add constraint FKDC7E31E2B3DFB11D foreign key (STORAGE_CONTAINER_ID) references CATISSUE_STORAGE_CONTAINER (IDENTIFIER)
...
alter table CATISSUE_ST_CONT_COLL_PROT_REL add index FK5A00CB6948304401 (COLLECTION_PROTOCOL_ID), add constraint FK5A00CB6948304401 foreign key (COLLECTION_PROTOCOL_ID) references CATISSUE_COLLECTION_PROTOCOL (IDENTIFIER)
alter table CATISSUE_ST_CONT_COLL_PROT_REL add index FK5A00CB69B3DFB11D (STORAGE_CONTAINER_ID), add constraint FK5A00CB69B3DFB11D foreign key (STORAGE_CONTAINER_ID) references CATISSUE_STORAGE_CONTAINER (IDENTIFIER)
...
alter table CATISSUE_REVIEW_PARAMS add index FK780ADBD191092806 (REPORT_ID), add constraint FK780ADBD191092806 foreign key (REPORT_ID) references CATISSUE_PATHOLOGY_REPORT (IDENTIFIER)
alter table CATISSUE_REVIEW_PARAMS add index FK780ADBD12206F20F (USER_ID), add constraint FK780ADBD12206F20F foreign key (USER_ID) references CATISSUE_USER (IDENTIFIER)
...
alter table CATISSUE_RETURN_EVENT_PARAM add index FK8F6C44D5BC7298A9 (IDENTIFIER), add constraint FK8F6C44D5BC7298A9 foreign key (IDENTIFIER) references CATISSUE_SPECIMEN_EVENT_PARAM (IDENTIFIER)
...
alter table CATISSUE_STOR_TYPE_HOLDS_TYPE add index FK185C50B59A3CE5C (STORAGE_TYPE_ID), add constraint FK185C50B59A3CE5C foreign key (STORAGE_TYPE_ID) references CATISSUE_STORAGE_TYPE (IDENTIFIER)
alter table CATISSUE_STOR_TYPE_HOLDS_TYPE add index FK185C50B81236791 (HOLDS_STORAGE_TYPE_ID), add constraint FK185C50B81236791 foreign key (HOLDS_STORAGE_TYPE_ID) references CATISSUE_STORAGE_TYPE (IDENTIFIER)
...
alter table CATISSUE_STORTY_HOLDS_SPARRTY add index FK70F57E4459A3CE5C (STORAGE_TYPE_ID), add constraint FK70F57E4459A3CE5C foreign key (STORAGE_TYPE_ID) references CATISSUE_STORAGE_TYPE (IDENTIFIER)
alter table CATISSUE_STORTY_HOLDS_SPARRTY add index FK70F57E44ECE89343 (SPECIMEN_ARRAY_TYPE_ID), add constraint FK70F57E44ECE89343 foreign key (SPECIMEN_ARRAY_TYPE_ID) references CATISSUE_SPECIMEN_ARRAY_TYPE (IDENTIFIER)
...
alter table CATISSUE_ENTITY_MAP_CONDITIONS add index FKDE84F0FB11B8FADA (ENTITY_MAP_ID), add constraint FKDE84F0FB11B8FADA foreign key (ENTITY_MAP_ID) references CATISSUE_ENTITY_MAP (IDENTIFIER)
