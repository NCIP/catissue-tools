...
alter table CATISSUE_PARTICIPANT add index FK_PARTICIPANT_ADDRESS (ADDRESS_ID), add constraint FK_PARTICIPANT_ADDRESS foreign key (ADDRESS_ID) references CATISSUE_ADDRESS (IDENTIFIER);
/***************************/
commit;
